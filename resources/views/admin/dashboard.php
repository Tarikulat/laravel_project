...
<div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="{{ route('sale.index') }}" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-red">
            ...
            <a href="{{ route('production.index') }}" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
