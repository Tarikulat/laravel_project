...
class ProductController extends Controller
{
    ...
    {
        $category = Category::all()->pluck('nama_category', 'id_category');
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('img', function ($product) {
                return '<span class="label label-success">'. $product->img .'</span>';
            })


            ->addColumn('code_product', function ($produk) {
